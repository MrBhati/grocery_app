                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                  image: DecorationImage(
                                      image: NetworkImage(
                                          "https://cccapi.cococa.in/public/uploads/product_images/product_image_1200x1200/test-PASSION.jpg"),
                                      fit: BoxFit.contain)),
                  ...
                  child: Row(
                    children: [
                      Expanded(
                        ...
                        child: Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Text("Meriiboy Passion Fruit Ice Cream",
                              style: GoogleFonts.lato(
                                  fontWeight: FontWeight.bold,
                                  fontSize: 15,
                                  color: Colors.black)),
                            ...
                            ScrollOnExpand(
                              ...
                              child: ExpandablePanel(
                                ...
                                collapsed: SingleChildScrollView(
                                  ...
                                  physics: BouncingScrollPhysics(),
                                  child: Text(
                                      "Meriiboy is one of the largest producers of fresh ice cream, based in South India. A division of Cousins Group, the business venture was founded in 1990, by 5 closely-knit families. The brand is known across Kerala and in the emerging markets of Tamil Nadu and Karnataka for its original freshness and unmatched quality, which is nothing less than world class. Tetra Pak Hoyer, Denmark, are consultants and quality advisors for the brand."
                                          .toString()
                                          .toLowerCase(),
                                      softWrap: true,
                                      maxLines: 2,
                                ...
                                expanded: SingleChildScrollView(
                                  ...
                                  children: <Widget>[
                                    Padding(
                                        ...
                                        child: Text(
                                            "Meriiboy is one of the largest producers of fresh ice cream, based in South India. A division of Cousins Group, the business venture was founded in 1990, by 5 closely-knit families. The brand is known across Kerala and in the emerging markets of Tamil Nadu and Karnataka for its original freshness and unmatched quality, which is nothing less than world class. Tetra Pak Hoyer, Denmark, are consultants and quality advisors for the brand.The brand is constantly exploring new and exciting flavours with new products like ice creams in real fruit shells, fresh fruit ice creams and milk lollies.."
                                                .toString()
                                                .toLowerCase(),
                                            softWrap: true,
                  ...
                  Container(
                    ...
                    child: Ink(
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          image: NetworkImage(
                              "https://cccapi.cococa.in/public/uploads/product_images/product_image_1200x1200/test-k.jpg"),
                          fit: BoxFit.contain,
                        ),
                      ),
                      child: InkWell(
